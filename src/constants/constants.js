export const projects = [
  ...
  },
  {
    ...
    description: "Predicting House Prices using RandomForest Regression from scikit-learn. Train/Test Datasets were cleaned and scaled for model fitting and prediction",
    image: '/images/house_prices.jpg',
    icon: '/images/icons/machine-learning.png',
    tags: ['NumPy', 'Pandas', 'sklearn'],
    source: 'https://github.com/saifmdev/regression_house_prices/blob/main/Linear_Regression.ipynb',
    visit: 'https://colab.research.google.com/github/saifmdev/regression_house_prices/blob/main/Linear_Regression.ipynb',
    id: 4,
  },
  {
